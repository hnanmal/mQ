...
class App(tk.Tk):
    def __init__(self):
        ...
        self.tree = ttk.Treeview(
            self, columns=("name", "description"), style="Custom.Treeview"
        )
    ...
    def add_numbered_item(self, parent, number, original_name, description, indent):
        item_id = self.tree.insert(
            parent, "end", text=number, values=(original_name, description)
        )
    ...
    def remove_selected_item(self):
        ...
        for item in selected_items:
            items_to_delete.update(self.get_descendants(item))
