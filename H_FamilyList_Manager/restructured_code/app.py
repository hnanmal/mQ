...
from modules.operations import CenterAreaOperations
...
class App(tk.Tk):
    def __init__(self):
        ...
        self.center_operations = CenterAreaOperations(self)
        self.treeview_operations = TreeviewOperations(self)  # Initialize Treeview operations
        self.config_manager = ConfigurationManager(self)  # Initialize Configuration Manager
        self.drag_and_drop_manager = DragAndDropManager(self)  # Initialize Drag and Drop Manager
        self.search_manager = SearchManager(self)  # Initialize Search Manager
        ...
        self.config_manager.load_default_configuration()
